...
void ListaProductos::agregaraBasedeDatos(string anombre, string amarca, string anSerie, int aPrecio, int aCantidad, string acategoria){
        nnombre = anombre;
        marca = amarca;
        nSerie = anSerie;
        Precio = aPrecio;
